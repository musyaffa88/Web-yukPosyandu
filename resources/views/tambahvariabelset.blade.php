...
@endsection
@section('content')
<form action="{{url('/simpanvariabelset')}}" method="post">
    @csrf
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <strong class="card-title">Tambah Himpunan</strong>
            </div>
            <div class="card-body">
                <div class="form-row">
                ...
                <div class="form-group col-md-3">
                    <label>Kode</label>
                    <input type="text" name="kode" class="form-control" id="inputEmail4" required="required">
                </div>
                <div class="form-group col-md-1">
                    <label>Range</label>
                    <input type="number" name="min" class="form-control" id="inputEmail4"> 
                </div>
                    <div class="form-group col-md-1">
                        <label>+</label>
                        <input type="number" name="max" class="form-control" id="inputEmail4">
                    </div>
                <div class="form-group col-md-3">
                  <label>Kurva</label>
                  <div>
